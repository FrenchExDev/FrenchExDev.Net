...
/// <summary>
/// Represents the vagrant cloud box create command.
/// </summary>
public sealed class VagrantCloudBoxCreateCommand : VagrantCloudCommand
{
    ...
    {
        var args = new List<string> { "cloud", "box", "create" };
