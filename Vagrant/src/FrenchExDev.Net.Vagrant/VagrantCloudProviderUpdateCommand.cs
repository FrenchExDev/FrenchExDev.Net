...
/// <summary>
/// Represents the vagrant cloud provider update command.
/// </summary>
public sealed class VagrantCloudProviderUpdateCommand : VagrantCloudCommand
{
    ...
    {
        var args = new List<string> { "cloud", "provider", "update" };
