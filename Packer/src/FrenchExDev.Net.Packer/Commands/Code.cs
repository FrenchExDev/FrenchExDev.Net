...
/// <summary>
/// Defines a mechanism for constructing instances of a specified type.
/// </summary>
...
public sealed class PackerBuildCommandBuilder : IBuilder<PackerBuildCommand>
{
    private bool? _debug;
    ...
    public PackerBuildCommand Build()
    {
...
/// thread-safe.</remarks>
public sealed class PackerInstallPluginCommandBuilder : IBuilder<PackerInstallPluginCommand>
{
    ...
    public PackerInstallPluginCommand Build()
    {
