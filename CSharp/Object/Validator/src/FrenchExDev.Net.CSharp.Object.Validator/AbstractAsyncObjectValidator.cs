...
public abstract class AbstractAsyncObjectValidator<TClass> : IAsyncObjectValidator<TClass>
{
    /// <summary>
    ...
    public async Task<IEnumerable<IObjectValidation>> ValidateAsync(TClass instance, CancellationToken cancellationToken = default)
    {
        var list = new List<IObjectValidation>();
    ...
    protected abstract Task ValidateInternalAsync(TClass instance, List<IObjectValidation> validations, CancellationToken cancellationToken = default);
}