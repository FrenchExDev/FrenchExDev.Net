...
public class LambdaAsyncObjectBuilder<TClass> : AbstractAsyncObjectBuilder<TClass>
{
    /// <summary>
    /// Holds the lambda function used to build the object.
    /// </summary>
    private readonly Func<Dictionary<object, object>, CancellationToken, Task<IObjectBuildResult<TClass>>> _buildFunc;
    ...
    public LambdaAsyncObjectBuilder(Func<Dictionary<object, object>, CancellationToken, Task<IObjectBuildResult<TClass>>> buildFunc)
    {
    ...
    /// <returns></returns>
    protected override async Task<IObjectBuildResult<TClass>> BuildInternalAsync(VisitedObjectsList visited, CancellationToken cancellationToken)
    {
        return await _buildFunc(visited, cancellationToken);
    }
}
