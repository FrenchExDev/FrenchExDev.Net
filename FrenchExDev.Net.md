...
```mermaid
graph LR
    proj["FrenchExDev.Net.Alpine.Version"]
```
...
```mermaid
graph LR
    proj["FrenchExDev.Net.Alpine.Version.Testing"]
    Shouldly["Shouldly"]
    proj --> Shouldly
```
...
graph LR
    ...
    C__code_FrenchExDev_Net_FrenchExDev_Net_i2_FrenchExDev_Net_HttpClient_src_FrenchExDev_Net_HttpClient_Testing_FrenchExDev_Net_HttpClient_Testing_csproj["FrenchExDev.Net.HttpClient.Testing"]
    proj --> C__code_FrenchExDev_Net_FrenchExDev_Net_i2_FrenchExDev_Net_HttpClient_src_FrenchExDev_Net_HttpClient_Testing_FrenchExDev_Net_HttpClient_Testing_csproj
    C__code_FrenchExDev_Net_FrenchExDev_Net_i2_FrenchExDev_Net_Alpine_src_FrenchExDev_Net_Alpine_Version_FrenchExDev_Net_Alpine_Version_csproj["FrenchExDev.Net.Alpine.Version"]
...
```mermaid
graph LR
    proj["FrenchExDev.Net.Alpine.Version.Tests"]
...
graph LR
    ...
    C__code_FrenchExDev_Net_FrenchExDev_Net_i2_FrenchExDev_Net_Alpine_src_FrenchExDev_Net_Alpine_Version_Testing_FrenchExDev_Net_Alpine_Version_Testing_csproj["FrenchExDev.Net.Alpine.Version.Testing"]
    proj --> C__code_FrenchExDev_Net_FrenchExDev_Net_i2_FrenchExDev_Net_Alpine_src_FrenchExDev_Net_Alpine_Version_Testing_FrenchExDev_Net_Alpine_Version_Testing_csproj
```
...
```mermaid
graph LR
    proj["FrenchExDev.Net.CSharp.ManagedDictionary"]
```
...
```mermaid
graph LR
    proj["FrenchExDev.Net.CSharp.ManagedDictionary.Testing"]
```
